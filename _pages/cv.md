...
* **2025 - 2026**: Master 2 in BioHealth Engineering, Université Grenoble Alpes, France
  * [GPA](https://vo-thanh-phuong.github.io/files/M2_BHE_transcript.pdf): 16.41/20 (1<sup>st</sup> semester) - Top 3<sup>rd</sup> in class.
...
======
### Apr 2026 - Sep 2026: Master’s intern
...
### 2020 - 2023: Research Assistant - Computer-aided Drug Design Laboratory, Department of Medicinal Chemistry
  ...
  * Duties included:
    ...
    * Discover small molecule inhibitors against Matrix Metalloproteinases (MMPs) [*[Poster](https://vo-thanh-phuong.github.io/files/BIO2023_HB_P14_apo.pdf)*], Interleukin-21 and Interleukin-21 receptor.
...
### Conferences
1. Image-based Classification Model Predicting P-glycoprotein Inhibitors. *The 2ⁿᵈ International Conference on Chemical Sciences*. **2024** [*[Poster](https://vo-thanh-phuong.github.io/files/ICCS2024-Pgp.pdf)*]
2. Virtual Screening for Small Molecule Inhibitors against Interleukin-21 and Interleukin-21 Receptor in Treatment of Rheumatoid Arthritis. *Pharmaceutical Science and Technology Conference 40*. **2024** [*[Poster](https://vo-thanh-phuong.github.io/files/SS2-PO-10.pdf)*]
...
* **Molecular modeling:** Protein structure prediction (AlphaFold), Pharmacophore modeling (MOE), Molecular docking (AutoDock Vina, HADDOCK), Molecular dynamics simulation (GROMACS), Cheminformatics (RDKit).
* **Artificial intelligence:** Machine learning (Scikit-learn), Deep learning (TensorFlow).
* **Programming:** Python, Bash.
* **Computational environment:** Linux, HPC systems.
* **Visualization:** MOE, PyMOL, VMD.
...
Languages
======
1. **English:** IELTS academic 6.5 – CEFR level B2
2. **Vietnamese:** Native
